...
+!init
   <- 
     ...
     -+tasks([]);
     +round(30); //variable de distancia de vuelta hasta la bandera.
     +distance(15);//variable de la distancia desde el centro del lado del cuadrado y el punto al que se quiera ir.
     +corner(0). 
