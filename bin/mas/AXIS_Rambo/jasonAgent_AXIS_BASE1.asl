...
+captainpos(CAPTAINPOSX,0,CAPTAINPOSZ): time(Y) & Y==2
	<- -captainpos(_);
		.my_name(ME);
		-+time(3);
		-+posObjective(CAPTAINPOSX+30,0,CAPTAINPOSZ-28);
		!add_task(task(3000,"TASK_GOTO_POSITION",ME,pos(CAPTAINPOSX+30,0,CAPTAINPOSZ-28),""));
		!add_task(task(2999,"TASK_GOTO_POSITION2",ME,pos(CAPTAINPOSX+31,0,CAPTAINPOSZ-28),""));
		-+state(standing).
