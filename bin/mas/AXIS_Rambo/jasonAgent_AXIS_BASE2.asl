...
+captainpos(CAPTAINPOSX,0,CAPTAINPOSZ): time(Y) & Y==2
	<- -captainpos(_);
		.my_name(ME);
		-+time(3);
		-+posObjective(CAPTAINPOSX+20,0,CAPTAINPOSZ-6);
		!add_task(task(3000,"TASK_GOTO_POSITION",ME,pos(CAPTAINPOSX+20,0,CAPTAINPOSZ-6),""));
		!add_task(task(2999,"TASK_GOTO_POSITION2",ME,pos(CAPTAINPOSX+21,0,CAPTAINPOSZ-5),""));
		-+state(standing).
