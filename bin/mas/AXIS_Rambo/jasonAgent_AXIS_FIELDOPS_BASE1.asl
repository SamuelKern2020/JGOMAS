...
+captainpos(CAPTAINPOSX,0,CAPTAINPOSZ): time(Y) & Y==2
	<- -captainpos(_);
		.my_name(ME);
		-+time(3);
		-+posObjective(CAPTAINPOSX+31,0,CAPTAINPOSZ-38);
		!add_task(task(3000,"TASK_GOTO_POSITION",ME,pos(CAPTAINPOSX+31,0,CAPTAINPOSZ-38),""));
		!add_task(task(2999,"TASK_GOTO_POSITION2",ME,pos(CAPTAINPOSX+32,0,CAPTAINPOSZ-38),""));
		-+state(standing).
...
+captainpos(CAPTAINPOSX,0,CAPTAINPOSZ): time(Y) & Y==1
	<- -captainpos(_);
		...
		?time(TIME);
		-+time(TIME+1);
		-+posObjective(CAPTAINPOSX-6,0,CAPTAINPOSZ);
		!add_task(task(3000,"TASK_GOTO_POSITION",ME,pos(CAPTAINPOSX-6,0,CAPTAINPOSZ),""));
		-+state(standing).
...
+captainpos(CAPTAINPOSX,0,CAPTAINPOSZ)
	<- -captainpos(_);
		...
		?time(TIME);
		-+time(TIME+1);
		-+posObjective(CAPTAINPOSX-6,0,CAPTAINPOSZ-3);
		!add_task(task(3000,"TASK_GOTO_POSITION",ME,pos(CAPTAINPOSX-6,0,CAPTAINPOSZ-3),""));
		-+state(standing).
